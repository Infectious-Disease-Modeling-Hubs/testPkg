...
[![R-CMD-check](https://github.com/Infectious-Disease-Modeling-Hubs/testPkg/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/Infectious-Disease-Modeling-Hubs/testPkg/actions/workflows/R-CMD-check.yaml)
<!-- badges: end -->
