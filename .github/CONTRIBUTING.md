# Contributing to testPkg

This outlines how to propose a change to `testPkg`. 
...
*   Fork the package and clone onto your computer. If you haven't done this before, we recommend using `usethis::create_from_github("Infectious-Disease-Modeling-Hubs/testPkg", fork = TRUE)`.
...
Please note that the testPkg project is released with a
